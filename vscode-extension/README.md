...
It launches Mull's language server to report wiki errors and provides format-on-save, syntax highlighting, square-bracket editing behavior, and prose-friendly word wrapping.
